(self.webpackChunk_keplr_wallet_extension=self.webpackChunk_keplr_wallet_extension||[]).push([[19],{35095:(e,t,r)=>{"use strict";r.d(t,{Y:()=>b});var n=r(2784),o=r(65397),l=r(22386),a=r(35150),i=r(4922),s=r(27660),c=r(34208),d=r(28432),m=r(50597),g=r(98095),u=r(45493),h=r(1522),f=r(39251),p=r(19410),y=r(41195),w=r(83112),v=r(42670);const E=(0,y.default)(i.i0)`
  font-weight: 600;
  font-size: 0.75rem;
  line-height: 1.25;

  margin-left: 0.25rem;
`,b=(0,g.Pi)((({isOpen:e,close:t,historyType:r,recipientConfig:g,memoConfig:b,permitSelfKeyInfo:V})=>{var Z;const{analyticsStore:x,uiConfigStore:k,keyRingStore:F}=(0,u.oR)(),$=(0,w.Z)(),S=(0,y.useTheme)(),[z,A]=(0,n.useState)("recent"),[O,M]=(0,n.useState)([]),[L,B]=(0,n.useState)([]);(0,n.useEffect)((()=>{k.addressBookConfig.getRecentSendHistory(g.chainId,r).then((e=>{M(e)}))}),[r,g.chainId,k.addressBookConfig]),(0,n.useEffect)((()=>{var e;k.addressBookConfig.getVaultCosmosKeysSettled(g.chainId,V||null===(e=F.selectedKeyInfo)||void 0===e?void 0:e.id).then((e=>{B(e.filter((e=>"fulfilled"===e.status)).map((e=>{if("fulfilled"===e.status)return e.value;throw new Error("Unexpected status")})))}))}),[null===(Z=F.selectedKeyInfo)||void 0===Z?void 0:Z.id,V,g.chainId,k.addressBookConfig]);const R=(()=>{switch(z){case"recent":return O.map((e=>({timestamp:e.timestamp,address:e.recipient,memo:e.memo})));case"contacts":return k.addressBookConfig.getAddressBook(g.chainId).map((e=>({name:e.name,address:e.address,memo:e.memo})));case"accounts":return L.map((e=>{var t;const r=(null===(t=F.selectedKeyInfo)||void 0===t?void 0:t.id)===e.vaultId;return{name:e.name,address:e.bech32Address,isSelf:r}}));default:return[]}})();return n.createElement(o.u,{isOpen:e,close:t,align:"bottom"},n.createElement(l.x,{backgroundColor:"light"===S.mode?a.VZ.white:a.VZ["gray-600"],paddingX:"0.75rem",paddingTop:"1rem"},n.createElement(l.x,{paddingX:"0.5rem",paddingY:"0.375rem"},n.createElement(i.d1,null,n.createElement(v.Z,{id:"components.address-book-modal.title"}))),n.createElement(s.T,{size:"0.75rem"}),n.createElement(d.B,{alignX:"left"},n.createElement(c.QK,{items:[{key:"recent",text:$.formatMessage({id:"components.address-book-modal.recent-tab"})},{key:"contacts",text:$.formatMessage({id:"components.address-book-modal.contacts-tab"})},{key:"accounts",text:$.formatMessage({id:"components.address-book-modal.my-account-tab"})}],selectedKey:z,onSelect:e=>{x.logEvent("click_addressBook_tab",{tabName:e}),A(e)}})),n.createElement(s.T,{size:"0.75rem"}),R.length>0?n.createElement(p.Z,{style:{maxHeight:"23.625rem",minHeight:"14.875rem",overflowY:"auto"}},n.createElement(m.K,{gutter:"0.75rem"},(()=>{if("accounts"!==z||!V)return R.map(((e,r)=>n.createElement(f.U,{key:r,timestamp:e.timestamp,name:e.name,address:e.address,memo:e.memo,isShowMemo:"accounts"!==z,onClick:()=>{var r;g.setValue(e.address),b.setValue(null!==(r=e.memo)&&void 0!==r?r:""),t()}})));const e=R.find((e=>e.isSelf)),r=R.filter((e=>!e.isSelf));return n.createElement(n.Fragment,null,e?n.createElement(n.Fragment,null,n.createElement(E,null,n.createElement(v.Z,{id:"components.address-book-modal.current-wallet"})),n.createElement(f.U,{name:e.name,address:e.address,isShowMemo:!1,onClick:()=>{g.setValue(e.address),t()},highlight:!0}),n.createElement(s.T,{size:"1.375rem"})):null,r.length>0?n.createElement(n.Fragment,null,n.createElement(E,null,n.createElement(v.Z,{id:"components.address-book-modal.other-wallet"})),r.map(((e,r)=>n.createElement(f.U,{key:r,name:e.name,address:e.address,isShowMemo:!1,onClick:()=>{g.setValue(e.address),t()}})))):null)})(),n.createElement(s.T,{size:"0.75rem"}))):n.createElement(l.x,{alignX:"center",alignY:"center",style:{height:"14.875rem",color:"light"===S.mode?a.VZ["gray-200"]:a.VZ["gray-400"]}},n.createElement(h.z,{top:"3rem"},n.createElement(d.B,{alignX:"center"},n.createElement(C,{size:"4.5rem"}),n.createElement(s.T,{size:"1.25rem"}),n.createElement(i.DY,null,"accounts"===z?$.formatMessage({id:"components.address-book-modal.empty-view-accounts"}):$.formatMessage({id:"components.address-book-modal.empty-view-default"})))))))})),C=({size:e})=>n.createElement("svg",{xmlns:"http://www.w3.org/2000/svg",width:e,height:e,fill:"none",viewBox:"0 0 72 72"},n.createElement("path",{stroke:"currentColor",strokeLinecap:"round",strokeLinejoin:"round",strokeWidth:"7.5",d:"M45.5 40.5h-18m12.182-21.568l-6.364-6.364a4.5 4.5 0 00-3.182-1.318H14A6.75 6.75 0 007.25 18v36A6.75 6.75 0 0014 60.75h45A6.75 6.75 0 0065.75 54V27A6.75 6.75 0 0059 20.25H42.864a4.5 4.5 0 01-3.182-1.318z"}))},39251:(e,t,r)=>{"use strict";r.d(t,{U:()=>y});var n=r(2784),o=r(22386),l=r(3645),a=r(4922),i=r(2712),s=r(47556),c=r(35150),d=r(75263),m=r(83112),g=r(42670),u=r(27660),h=r(16468),f=r(28432),p=r(41195);const y=({timestamp:e,name:t,address:r,memo:y,isShowMemo:w,onClick:v,dropdownItems:E,highlight:b})=>{const C=(0,m.Z)(),V=(0,p.useTheme)(),[Z,x]=(0,n.useState)(!1);return n.createElement(o.x,{padding:"1rem",backgroundColor:"light"===V.mode?c.VZ["gray-50"]:c.VZ["gray-600"],hover:{backgroundColor:v?"light"===V.mode?c.VZ["gray-100"]:c.VZ["gray-550"]:void 0},borderRadius:"0.375rem",borderWidth:b?"1px":void 0,borderColor:b?c.VZ["gray-400"]:void 0,cursor:v?"pointer":void 0,onClick:e=>{e.preventDefault(),v&&v()}},n.createElement(l.o,{sum:1,alignY:"center"},n.createElement(l.s,{weight:1},n.createElement(f.B,null,e?n.createElement(n.Fragment,null,n.createElement(a.H5,{style:{color:"light"===V.mode?c.VZ["gray-700"]:c.VZ["gray-10"]}},n.createElement(g.Z,{id:"components.address-item.sent-on-date",values:{date:C.formatDate(new Date(e),{year:"numeric",month:"long",day:"2-digit"})}})),n.createElement(u.T,{size:"0.5rem"})):null,t?n.createElement(n.Fragment,null,n.createElement(a.H5,{style:{color:"light"===V.mode?c.VZ["gray-700"]:c.VZ["gray-10"],width:"16rem",whiteSpace:"nowrap",overflow:"hidden",textOverflow:"ellipsis"}},t),n.createElement(u.T,{size:"0.5rem"})):null,n.createElement(f.K,{alignY:"center"},n.createElement(i.m2,{width:"0.75rem",height:"0.75rem",color:"light"===V.mode?c.VZ["gray-300"]:c.VZ["gray-200"]}),n.createElement(u.T,{size:"0.25rem"}),n.createElement(a.pN,{style:{color:"light"===V.mode?c.VZ["gray-300"]:c.VZ["gray-200"]}},d.Bech32Address.shortenAddress(r,30))),n.createElement(u.T,{size:"0.25rem"}),w?n.createElement(f.K,{alignY:"center"},n.createElement(i.YH,{width:"0.75rem",height:"0.75rem",color:"light"===V.mode?c.VZ["gray-300"]:c.VZ["gray-200"]}),n.createElement(u.T,{size:"0.25rem"}),y?n.createElement(a.pN,{style:{color:"light"===V.mode?c.VZ["gray-300"]:c.VZ["gray-200"],width:"15rem",whiteSpace:"nowrap",overflow:"hidden",textOverflow:"ellipsis"}},y):n.createElement(a.pN,{style:{color:c.VZ["gray-300"]}},n.createElement(g.Z,{id:"components.address-item.empty-memo"}))):null)),E&&E.length>0?n.createElement(s.Rk,{isOpen:Z,close:()=>x(!1),items:E},n.createElement(h.h,{onClick:()=>x(!Z),color:"light"===V.mode?c.VZ["gray-300"]:c.VZ["gray-10"]},n.createElement(i.ws,{width:"1.5rem",height:"1.5rem"}))):null))}},3554:(e,t,r)=>{"use strict";r.d(t,{B:()=>a});var n=r(2784),o=r(41195);const l={YAxis:o.default.div`
    display: flex;
